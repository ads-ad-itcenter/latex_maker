...
\twocolumn[
    ...
    \begin{abstract}
        {\normalsize
            ...
            本論文ではこの生態と、 \LaTeX の書き方を示し、論文作成の際のテンプレートになることを目的とする。
            \par
        }
    \end{abstract}
...
\LaTeX は科学論文に用いられているという背景から、数式の表示には豊富な機能を持っている。
...
\LaTeX は歴史の深いソフトウェアであるため、知りたいことの多くはネット検索で済む。
日本語のサイトだと『TeX Wiki\footnote{\url{https://texwiki.texjp.org/}}』が特に参考になるだろう。
また、奥村晴彦著の書籍『LaTeX2$\epsilon$美文書作成入門』は多くのユーザーに愛用されている。
